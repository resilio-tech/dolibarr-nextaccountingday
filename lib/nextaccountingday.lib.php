...
function nextaccountingdayAdminPrepareHead()
{
	...
	/*
	$head[$h][0] = dol_buildpath("/nextaccountingday/admin/myobject_extrafields.php", 1);
	...
	*/
	...
	//$this->tabs = array(
	//	'entity:+tabname:Title:@nextaccountingday:/nextaccountingday/mypage.php?id=__ID__'
	//); // to add new tab
	//$this->tabs = array(
	//	'entity:-tabname:Title:@nextaccountingday:/nextaccountingday/mypage.php?id=__ID__'
	//); // to remove a tab
